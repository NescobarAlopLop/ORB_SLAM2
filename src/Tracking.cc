	...
	void Tracking::Track()
	{
		...
		else
		{
			...
			if(!mbOnlyTracking)
			{
				...
				{
					cout<<"LINE 357 LINE 357 LINE 357 LINE 357 "<<endl;
					//bOK = Relocalization();
			...
			else
			{
				...
				if(mState==LOST)
				{
					cout<<"LINE 369 LINE 369 LINE 369 LINE 369 "<<endl;
					//bOK = Relocalization();
					bOK=RelocalizationNewPnP();
					cout<<"LINE 369 LINE 369 LINE 369 LINE 369 "<<endl;
...
//					if(!mbVO)
					...
					else
					{
						...
						cout<<"LINE 403 LINE 403 LINE 403 LINE 403 "<<endl;
	...
	cv::Mat Tracking::getTransformData()
{
	...
	{
		// //firas demo day
		// ofstream losttrackingfile;
		// losttrackingfile.open ("trackstate.txt");
		// losttrackingfile << "0";
		// losttrackingfile.close();
		cout<<"noooooo newwwww"<<endl;
