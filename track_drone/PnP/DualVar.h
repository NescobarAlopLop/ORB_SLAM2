...
namespace PnP
{
	...
	class DualVar
	{
	 public:
		...
		std::tuple<Eigen::Matrix3d, Eigen::Vector3d, double> convert_to_rotation_translation_cost(const std::shared_ptr<PnpObjective>&, const std::shared_ptr<BarrierMethodSettings>&);
	};
}
